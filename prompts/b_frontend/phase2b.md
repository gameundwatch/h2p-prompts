...
あわせて、このプロジェクトの**移行スコープ**を確定する：出口は「構造の再設計と
移行計画の確立＋最初の数ステップの実行」まで。どこまでを今回の範囲とし、
どこからを生成 CLAUDE.md に委ねるかの線を引く。
...
- スコープを勝手に広げない。出口（再設計＋移行計画＋数ステップ）を超えない。
